...
})({"fT9G8":[function(require,module,exports) {
"use strict";
...
function displayBook(book) {
    return `${book.title} de ${book.author} are pretul de ${book.localPrice} ${currency.local} (${book.euroPrice()} ${currency.international})`;
}
...
},{}]},["fT9G8","bhPPS"], "bhPPS", "parcelRequire94c2")
